...
summary: GitFit is a React.js-driven application designed to discover and organize your workouts, track progress, and interact with users and trainers. Node.js and Express.js are used as the server-side framework, and data is handled by GraphQL, MongoDB and MongoDB Atlas.
images:
  - "/images/projects/git-fit/git-fit-01.png"
team:
  - name: "Nicholas Krilis"
    role: "Software Engineer"
    avatar: "/images/avatar.png"
    linkedIn: "www.linkedin.com/in/nicholas-krilis"
link: "https://gitfit-2.herokuapp.com/"
---
